...
const _SAMOUCZEK_SLAJDY = {
  ...
  { ikona: 'aparat', tytul: 'Cztery drogi do produktu',
    opis: 'Możesz zeskanować kod kreskowy, poszukać po nazwie, zrobić zdjęcie <b>przodu opakowania</b> (apka dopasuje produkt w bazie Open Food Facts) albo zdjęcie <b>tabeli wartości odżywczych</b>, gdy produktu nigdzie nie ma. Cztery drogi, bo w sklepie działa co innego niż w kuchni. Przy każdym zdjęciu wybierasz „Aparat" albo „Z dysku" — telefon nie daje obu naraz w jednym kroku, więc wybór jest po naszej stronie.' },
  { ikona: 'mikrofon', tytul: 'Powiedz albo opisz',
    opis: 'Mikrofon przy polu szukania przyjmuje mowę: krótka nazwa idzie do wyszukiwarki, całe zdanie („dwa jajka i kromka chleba") do AI, które rozbije je na pozycje. Zanim cokolwiek trafi do dnia, zobaczysz listę z ptaszkami i gramaturami do poprawienia — oszacowanie zostaje oszacowaniem, dopóki go nie zatwierdzisz.' },
  ...
  { ikona: 'przeplyw', tytul: 'Składnik skądkolwiek',
    opis: 'Dokładając składnik, masz to samo co w dzienniku: skan kodu, zdjęcie, mikrofon, „Opisz słowami" i <b>„Z dziennika"</b> — stamtąd weźmiesz pojedynczą pozycję albo całe danie z dowolnego dnia. Przepis najczęściej powstaje z czegoś, co już raz zjadłeś, więc przepisywanie tego z ręki było pracą za darmo.' },
  { ikona: 'kodkreskowy', tytul: 'Baza produktów',
    opis: 'Zakładka „Produkty" to wszystko, co apka już zna — z wyszukiwarką i podziałem na to, co przyszło z zewnętrznej bazy, i to, co wpisaliście sami. Tu też dokładasz produkt, którego <b>nie zna żaden kod kreskowy</b>: zdjęciem przodu, zdjęciem tabeli, opisem słowami (AI oszacuje wartości <b>na 100 g</b>) albo z ręki. Wynik z opisu trafia najpierw do formularza z ramką „oszacowane przez AI" — zapisujesz dopiero, gdy go obejrzysz. Skan pokazuje przy okazji oceny, więc sprawdzisz produkt przy półce, nie dodając nic do dziennika.' },
  ...
  { ikona: 'analiza', tytul: 'Oś czasu i przebieg parametru',
    opis: 'Badania układają się na osi czasu, z odstępami proporcjonalnymi do upływu czasu — widać zagęszczenie przy chorobie i ciszę przy zdrowiu. Suwak <b>gęstości</b> zmienia wielkość kart (pełne / zwężone / skrót), więc przy długiej historii zmieścisz na ekranie kilkanaście wpisów zamiast czterech. Wpisy przefiltrujesz po problemie zdrowotnym, a klikając parametr zobaczysz jego przebieg na wykresie, z pasmem normy <b>schodkowym</b>, bo norma bywa inna w każdym laboratorium.' },
  { ikona: 'trend_dol', tytul: 'Masa ciała z celem',
    opis: 'Zakładka „Waga" to osobna strona na jeden pomiar dziennie: wpisujesz kilogramy, a apka pokazuje zmianę i wykres. Ustaw <b>wagę docelową i termin</b>, a dołoży linię tempa i powie wprost, czy jesteś przed planem, czy za wolno. Ważenia w domu (koło) i w przychodni (pierścień) stoją na jednej osi, bo to jedna historia ciała. Przy codziennym ważeniu włącz „Wygładź" — sama waga skacze o kilogram przez wodę i sól.' },
  ...
  { ikona: 'alerty', tytul: 'Termin sam przypomina',
    opis: 'Wystarczy ustawić datę — zadanie odezwie się <b>o 9:00</b> tego dnia. Przy terminie widać godzinę: przygaszona to ta domyślna, zwykłym pismem ta, którą wpisałeś sam. Stuknij w nią, żeby zmienić porę. Przesuniesz termin — przypomni się ponownie.' },
  { ikona: 'lista', tytul: 'Duże sprawy dziel na kroki',
    opis: 'Do każdego zadania dopiszesz kroki, a do kroków kolejne — tak głęboko, jak potrzebujesz. Na liście widzisz postęp („2/5") i tym samym przyciskiem zwijasz kroki; „Zwiń wszystkie" składa całą listę do samych spraw głównych.' },
  { ikona: 'uwaga', tytul: 'Priorytet i wstrzymanie',
    opis: 'Chorągiewka przy zadaniu ustawia ważność — wysoki priorytet dostaje czerwony wykrzyknik i przy równym terminie idzie wyżej. Sprawy, które czekają na kogoś innego, <b>wstrzymaj</b> (trzy kropki): znikną z listy otwartych i przestaną przypominać, ale nie udają zrobionych.' },
  { ikona: 'lupa', tytul: 'Filtry i szukanie',
    opis: 'Dwa rzędy filtrów odpowiadają na dwa różne pytania: <b>Kiedy</b> (cały czas / dziś / wkrótce) i <b>Stan</b> (otwarte / zrobione / wstrzymane / wszystkie). Ustaw „Cały czas + Wszystkie", żeby zobaczyć, co w projekcie już domknięte, a co wisi. Wyszukiwarka nad filtrami szuka <b>ponad nimi</b> — po nazwie i opisie, razem z zamkniętymi.' },
